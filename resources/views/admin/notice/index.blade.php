         ...
         @foreach($notices as $notice)
             ...
             <td>{{ $notice->created_at->format('d M y') }}</td>
			      <td>
			      	 ...
			      	 <!-- delete button -->
                        <a href="{{ route('admin.notice.delete', $notice->id) }}"
                           onclick="return confirm('Are you sure to delete notice?')">
       ...
       <!-- =======edit modal start======= -->
          <div class="modal fade" id="editModal">
            <div class="modal-dialog">
                <form id="editForm" action="{{route('admin.notice-update')}}" method="POST">
                    @csrf
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                              <label><strong>Name</strong></label>
                               <input type="text" name="description" id="edit_name" class="form-control mb-2">
