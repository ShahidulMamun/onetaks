                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        @if($setting->site_logo)
                            <img src="{{ asset('storage/'.$setting->site_logo) }}" width="80" class="mt-2 rounded">
                        @endif
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        @if($setting->favicon)
                            <img src="{{ asset('storage/'.$setting->favicon) }}" width="40" class="mt-2">
                        @endif
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="min_withdraw" class="form-control"
                            value="{{ old('min_withdraw', $setting->min_withdraw) }}">
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">Min Deposit</label>
                        <input type="number" step="0.01" name="min_deposit" class="form-control"
                            value="{{ old('min_deposit', $setting->min_deposit) }}">
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">Withdraw Charge (%)</label>
                        <input type="number" step="0.01" name="withdraw_charge" class="form-control"
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="meta_description" class="form-control" rows="2">{{ old('meta_description', $setting->meta_description) }}</textarea>
                    </div>
